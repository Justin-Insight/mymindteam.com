...
pay_as_you_go_block:
  ...
  body: >-
    Mind Team testing services can be paid in three simple installments
  ...
  installments:
    ...
    - heading: <span class="underline underline--secondary">Second</span> installment
      body: >-
        Make your second payment of at least <strong>50% of the remaining
        balance</strong> to schedule your assessment.
...
page_blocks:
  - heading: >-
      Self-pay rates for <span class="underline underline--primary">immediate
      support</span>.
    body: >-
      To offer the immediate answers, guidance and support you deserve, free
      from referral requirements and other obstacles, Mind Team does not accept
      insurance.


      However, we have partnered with <a target="_blank" rel="noopener
      noreferrer nofollower" href="https://reimbursify.com/">Reimbursify</a> and
      <a target="_blank" rel="noopener noreferrer nofollower"
      href="https://www.zaya.health/">Zaya Health</a> to assist you in getting
      your testing and/or treatment reimbursed (if your provider covers
      out-of-network testing and treatment), without the typical stress of
      filing a claim.
    button:
      enabled: false
      button_url:
...
faq_block:
  enabled: true
  heading: >-
    Frequently asked <span class="underline underline--secondary">payment
    option</span> questions
  questions:
    ...
    - question: Why does treatment pricing vary so much?
      answer: >-
        ...
        Some individuals work with interventionists, while others work with
        school psychologists or clinicians specializing in autism or ADHD
        treatment. Your hourly treatment rate will depend on the type of
        clinician that best suits your needs.
    - question: Do you accept insurance?
      answer: >-
        ...
        Or, you can utilize the assistance of <a target="_blank" rel="noopener
        noreferrer nofollower" href="https://reimbursify.com/">Reimbursify</a>
        and <a target="_blank" rel="noopener noreferrer nofollower"
        href="https://www.zaya.health/">Zaya Health</a>, who we’ve partnered
        with to make the reimbursement process less of a hassle.
    - question: How do I file a reimbursement claim?
      answer: >-
        Filing for reimbursement can be a difficult process, which is why we’ve
        partnered with <a target="_blank" rel="noopener noreferrer nofollower"
        href="https://reimbursify.com/">Reimbursify</a> and <a target="_blank"
        rel="noopener noreferrer nofollower"
        href="https://www.zaya.health/">Zaya Health</a>. These companies help
        file your claim quickly and do the hard work for you.
        ...
        service. Some providers require <a target="_blank" rel="noopener
        noreferrer nofollower"
        href="https://www.priorauthtraining.org/prior-authorization/">prior
        authorization</a> to approve reimbursement coverage.


        When contacting your provider, ask if any of the following <a
        target="_blank" rel="noopener noreferrer nofollower"
        href="https://www.ama-assn.org/practice-management/cpt/cpt-overview-and-code-approval">CPT
        codes</a> need prior authorization for qualify for reimbursement: 96130,
        96131, 96132, 96133, 96136, 96137, 96112, 96113, 96125.
